...
export default function OutstandingAmortizedCost() {
    ...
    const exportToExcel = () => {
        ...
        loadXLSX()
            .then((XLSX) => {
                ...
                XLSX.utils.book_append_sheet(wb, ws, 'Securities Outstanding Amortized Cost');
                
                // Generate filename
                const filename = `securities_outstanding_amortized_cost_${new Date().toISOString().split('T')[0]}.xlsx`;
    ...
    const exportToPDF = () => {
        ...
        const htmlContent = `
            ...
            <html>
            <head>
                <title>Securities Outstanding Amortized Cost</title>
                <style>
            ...
            <body>
                <div class="header-info">
                    <h1>Report Securities - Outstanding Amortized Cost</h1>
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Report Securities - Outstanding Amortized Cost" />
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>Securities Outstanding - Amortized Cost</CardTitle>
                        <CardDescription>
                            Data sekuritas outstanding dengan metode penilaian Amortized Cost
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
