...
export default function SimpleInterest() {
    ...
    const exportToExcel = () => {
        ...
        loadXLSX()
            .then((XLSX) => {
                ...
                XLSX.utils.book_append_sheet(wb, ws, 'Report Journal - Simple Interest');
    ...
    const exportToPDF = () => {
        ...
        const htmlContent = `
            ...
            <html>
            <head>
                <title>Report Journal - Simple Interest</title>
                <style>
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Report Loan - Report Journal - Simple Interest" />
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>Report Journal - Simple Interest</CardTitle>
                        <CardDescription>
                            Journal entries for loan transactions with simple interest
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
