// resources/js/Pages/ReportLoan/ReportOutstanding/SimpleInterest.tsx
...
export default function SimpleInterest() {
    ...
    const exportToExcel = () => {
        ...
        loadXLSX()
            .then((XLSX) => {
                ...
                const excelData = [
                    // Headers
                    ['No', 'Entity Number', 'Account Number', 'Debtor Name', 'GL Account',
                ...
                XLSX.utils.book_append_sheet(wb, ws, 'Report Outstanding - Simple Interest');
                
                // Generate filename
                const filename = `report_outstanding_simple_interest_${new Date().toISOString().split('T')[0]}.xlsx`;
    ...
    const exportToPDF = () => {
        ...
        const htmlContent = `
            ...
            <html>
            <head>
                <title>Report Outstanding - Simple Interest</title>
                <style>
            ...
            <body>
                <div class="header-info">
                    ...
                    <p><strong>Simple Interest Calculation</strong></p>
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Report Loan - Report Outstanding - Simple Interest" />
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>Report Outstanding - Simple Interest</CardTitle>
                        <CardDescription>
                            Data pinjaman outstanding dengan perhitungan Simple Interest
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
